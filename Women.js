...
const Women = () => {
  const [filteredProducts, setFilteredProducts] = useState(products.women);
  ...
  const handleFilterChange = (filterType, value) => {
    if (filterType === 'clear') {
      ...
      setFilteredProducts(products.women);
      return;
    }
  ...
  const subcategories = [
    { name: 'Dresses', link: '#', icon: 'fas fa-tshirt' },
    { name: 'Tops & T-Shirts', link: '#', icon: 'fas fa-tshirt' },
    { name: 'Jeans & Trousers', link: '#', icon: 'fas fa-tshirt' },
    { name: 'Ethnic Wear', link: '#', icon: 'fas fa-tshirt' },
    { name: 'Sleepwear', link: '#', icon: 'fas fa-tshirt' },
    { name: 'Activewear', link: '#', icon: 'fas fa-running' }
  ];
