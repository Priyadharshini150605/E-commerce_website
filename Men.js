...
const Men = () => {
  const [filteredProducts, setFilteredProducts] = useState(products.men);
  ...
  const handleFilterChange = (filterType, value) => {
    if (filterType === 'clear') {
      ...
      setFilteredProducts(products.men);
      return;
    }
  ...
  const subcategories = [
    { name: 'Shirts', link: '#', icon: 'fas fa-tshirt' },
    { name: 'T-Shirts', link: '#', icon: 'fas fa-tshirt' },
    ...
    { name: 'Jackets', link: '#', icon: 'fas fa-tshirt' }
  ];
